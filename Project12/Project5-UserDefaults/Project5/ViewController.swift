...
class ViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        currentWord = defaults.string(forKey: "currentWord") ?? allWords.randomElement()!
        usedWords = defaults.object(forKey: "entries") as? [String] ?? [String]()
    ...
    func save() {
        ...
        defaults.set(usedWords, forKey: "entries")
        print(defaults.object(forKey: "entries") as? [String] ?? [String]())
        print(defaults.string(forKey: "currentWord") ?? allWords.randomElement()!)
    }
    
    @objc func startGame() {
        currentWord = allWords.randomElement() ?? "silkworm" // Word the player has to found
        title = currentWord
