...
class ViewController: UIViewController {
    ...
    // Show message when user beat the best score
    func messageBestScore() {
        let ac = UIAlertController(title: "New Best Score!", message: "Your Best Score is \(bestScore)", preferredStyle: .alert)
        ac.addAction(UIAlertAction(title: "Continue", style: .default, handler: askQuestion))
        present(ac, animated: true, completion: nil)

        // Dismiss the alert for 0.5 second
