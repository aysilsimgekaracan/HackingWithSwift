...
class GameScene: SKScene {
    ...
    func createFirework(xMovement: CGFloat, x: Int, y: Int) {
        ...
        firework.colorBlendFactor = 1 // we can color the fireworks
        ...
        let path = UIBezierPath() // will represent the movement of the firework
        path.move(to: .zero)
    ...
    @objc func launchFireworks() {
        ...
        //Challenge 2
        launchCount += 1
        if launchCount > 10 { // End the game after 10 launches
